    ...
    function synthesis(uint256[] memory _tokenIds) external {
        ...
        for(uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            require(
                ...
                "RICH-NFT: These cards quality aren't equal"
            );
            ...
            require(
                ...
                "RICH-NFT: These cards cannot synthesis"
            );

            if (i == 0) {
                require(
                    _tokenIds.length == SYNTHESIS_CARD_NUMBER[quality],
                    "RICH-NFT: Number of card not enough"
                );
            }
        }
